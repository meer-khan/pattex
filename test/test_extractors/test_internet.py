...
from pattex.extractors.internet import (
    extract_urls,
...
"""
Tests for URL extraction functions in pattex.extractors.internet.

Run with: pytest test/test_extractors/test_urls.py -v
"""
